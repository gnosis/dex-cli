...
def trades(count, skip, sort, sort_ascending, print_format, verbose, trader):
    """Get trades"""
    get_trades(count=count, skip=skip, sort=sort, sort_ascending=sort_ascending, print_format=print_format, verbose=verbose, trader=trader)
